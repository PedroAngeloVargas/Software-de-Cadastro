...
// Visitantes.
// Alunos:
// Jo�o Pablo Soares Lino - Turma A
// Pedro �ngelo Tellaroli Vargas - Turma A
// Pedro Henrique Teixeira Da Silva - Turma B

// Declara��o das bibliotecas ultilizadas para constru��o do c�digo
#include <iostream>
#include <locale.h>
#include <fstream>
#include <stdlib.h>
...
// Declara��o do STD para n�o precisarmos ficar ultilizando ele toda hora
using namespace std;
...
// Fun��o do menu cadastro de pessoas
void SubMenu1()
{
    int subOpcao1;
    do
...
// Fun��o para gerar relat�rio de dependentes/associados
void SubMenu2()
{
    int op;
    string tecla;
    ...
    do
    {
        ...
        case 1:
            ...
            // Exibir informa��es dos associados
            system("cls");
            cout << "Associados: \n";
        ...
        case 2:
            ...
            // Exibir informa��es dos dependentes
            system("cls");
            cout << "\nDependentes: \n";
...
void excluirPessoa(const string &excluirPessoa)
{
    ...
    // Leitura do arquivo, copiando para o arquivo temporário, exceto a pessoa a ser excluída
    while (getline(arquivoPessoasIn, linha))
    {
        if (linha != excluirPessoa) // Verifica se a linha é igual à string fornecida
        {
    ...
    // Substituir o conteúdo original pelo conteúdo do arquivo temporário
    remove("pessoas.txt");
...
void excluirAssociado(const string &ExcluirAssociado)
{
    ...
    {
        if (linha != ExcluirAssociado) // Verifica se a linha é igual à string fornecida
        {
...
void excluirDependente(const string &ExcluirDependente)
{
    ...
    {
        if (linha != ExcluirDependente) // Verifica se a linha é igual à string fornecida
        {
...
void editaDependente()
{
    ...
    // Aqui precisa criar uma condicional para verificar se o c�digo de associado existe
...
void editaVisita()
{
    ...
    if (agenda == 'N' || agenda == 'n')
    {
        ...
        arquivoRegistro1.open("registrovisitas.txt", ios::in); // Abre o arquivo no modo de adi��o
        ofstream arquivoTemp("temp.txt", ios::out | ios::app);
        system("cls");
        arquivoTemp << "!AVISO! Registro com correcao, favor considerar este." << endl;
...
// Fun��o para cadastrar novas pessoas
void cadastrarPessoas(Tpessoas &pessoa)
{
    pessoa.cod_pessoa = contadorPessoa++;
    fstream arquivopessoas;                                       // Para salvar os dados das pessoas
    arquivopessoas.open("pessoas.txt", ios::out | std::ios::app); // Abre o arquivo no modo de adi��o
    ...
    cout << "Seu codigo de Pessoa ser�: " << pessoa.cod_pessoa << endl;
...
// Fun��o para cadastrar dados espec�ficos de associados
void cadastrarAssociados(Tassociados &associados, Tpessoas &pessoa) // Aqui precisar criar uma fun��o separada para calcular a mensalidade
{
    float taxaFixa = 200.0;
    float taxaPorDependente = 30.0;
    fstream arquivoAssociados;
    ...
    // Usa o c�digo da pessoa cadastrada
    arquivoAssociados.open("associados.txt", ios::out | std::ios::app); // Abre o arquivo no modo de adi��o
...
// Fun��o para cadastrar dados espec�ficos de dependentes
void cadastrarDependentes(Tdependentes &dependentes, Tassociados &associados, Tpessoas &pessoa)
{
    fstream arquivoDependentes;
    ...
    {
        // Atualiza o n�mero de dependentes do associado
        associados.numDependentes++;
        arquivoDependentes.open("dependentes.txt", ios::out | std::ios::app); // Abre o arquivo no modo de adi��o
...
// Fun��o para cadastrar dados espec�ficos de visitantes e registrar visitas
void cadastrarVisitantes(Tvisitantes &visitantes, Tpessoas &pessoa) // Aqui tem coisas para arrumar
{
    ...
    // Usa o c�digo da pessoa cadastrada
    arquivoVisitantes.open("visitantes.txt", ios::out | std::ios::app); // Abre o arquivo no modo de adi��o
    ...
    // Aqui precisa criar uma condicional para verficar se o c�digo existe
    cout << "Digite o codigo do Associado: ";
...
// Fun��o para fazer o registro de visitas
void registroVisita(Tpessoas &pessoa, Tvisitantes &visitantes, Tassociados &associados)
{
    cout << "Registro de visita\n\n";
    char agenda;
    cout << "Deseja agendar a visita? Se nao, faze-la agora mesmo? (Sim ou N�o): ";
    cin >> agenda;
    while (agenda != 'S' && agenda != 's' && agenda != 'N' && agenda != 'n')
    {
        cout << "Deseja agendar a visita? Se nao, faze-la agora mesmo? (Sim ou N�o): ";
    ...
    if (agenda == 'N' || agenda == 'n')
    {
        ...
        visitantes.mes_visita_inicial = mesAtual;
        visitantes.ano_visita_inicial = anoAtual;
        arquivoRegistro1.open("registrovisitas.txt", ios::out | ios::app); // Abre o arquivo no modo de adi��o
        system("cls");
        cout << "Digite o codigo do visitante: ";
        cin >> visitantes.cod_visitante;
...
// Fun��o para ler o valor mais alto do arquivo de pessoas
void lerContadorPessoa()
{
...
// Fun��o para ler o valor mais alto do arquivo de associados
void lerContadorAssociados()
{
...
// Fun��o para ler o valor mais alto do arquivo de dependentes
void lerContadorDependentes()
{
...
// Fun��o para ler o valor mais alto do arquivo de visitantes
void lerContadorVisitantes()
{
...
// Fun��o para obter data atual
void obterDataAtual(int &dia, int &mes, int &ano)
{
    time_t t = time(0);
    tm *now = localtime(&t);
    dia = now->tm_mday;
    mes = now->tm_mon + 1;     // O m�s � base 0
    ano = now->tm_year + 1900; // Contagem de anos desde 1900
}

// Fun��o para obter hor�rio atual
void obterHorarioAtual(int &horas, int &minutos)
{
    time_t t = time(0);
    tm *now = localtime(&t);
...
void obterDataAtual2(int &dia2, int &mes2, int &ano2)
{
    ...
    mes2 = dataAtual2->tm_mon + 1;     // O m�s � base 0, ent�o adicionamos 1
